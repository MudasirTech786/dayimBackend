              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                @endif
                  <div class="card-title text-center">
                    <div class="p-1">
                      <h3>Dayim Marketing</h3>
                    </div>
                  </div>
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span>Login with Dayim Marketing</span>
                  </h6>
                </div>
                ...
                <div class="card-footer">
                  <div class="">
                    ...
                    <!-- <p class="float-sm-right text-center m-0">New to Dayim Marketing? <a href="register-simple.html" class="card-link">Sign Up</a></p> -->
                  </div>
                </div>
              </div>
            </div>
