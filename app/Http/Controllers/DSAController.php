...
class DSAController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dsa.index')->with('success', 'Event has been Added successfully!');
    }
    ...
    public function get_dsa_events(Request $request)
    {

        $result = DSA::orderBy('created_at', 'DESC');
        ...
        foreach ($linksData as $aRow) {
            ...
            $action = "<span class=\"dropdown\">
                          ...
                          <span aria-labelledby=\"btnSearchDrop2\" class=\"dropdown-menu mt-1 dropdown-menu-right\">
                            <a href=\"dsa/{$aRow->id}/edit\" class=\"dropdown-item font-small-3\"><i class=\"la la-barcode font-small-3\"></i> edit</a>
    ...
    {
        $dayim = DSA::findOrFail($id);
        return view('admin.dsa.edit', compact('dayim'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('dsa.index')->with('success', 'Event has been Updated successfully!');
    }
